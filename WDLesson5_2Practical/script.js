...
3) Create an appropriate random price to display for each pizza (say 15 to 35). No HTML element needed.
4) Enter quantity is a text input. No need for id.
5) Buy is a button input. No need for placeholder.
...
function init(){
   ...
   for(let i = 1; i < 6; i++){
      build+= `<div class = "card">
                  ...
                  <p>$${(Math.random() * (35-15) + 15).toFixed(0)}</p>
